...
let rVal = outer(); //output ->Hello i am outer and i am returning Inner
console.log(rVal); //output -> [Function: inner]
rVal();//output->// I am Inner (here we are calling rval whichis return by inner() function)